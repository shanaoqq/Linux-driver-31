...
char kbuf[128] = {0};
int condition = 0; //Ìõ¼þ
wait_queue_head_t wq; //¶¨ÒåµÈ´ý¶ÓÁÐÍ·
		...
		size_t size, loff_t *offs)
{
	...
	condition = 1; //½«Ìõ¼þÉèÖÃÎªÕæ
	wake_up_interruptible(&wq); //»½ÐÑ¶ÓÁÐ
